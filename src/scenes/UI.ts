...
export default class UI extends Phaser.Scene{
    ...
    create()
    {
        ...
        this.changeRoomBox[0].BoxInterract(this.scene.scene, this.centerX-600, this.centerY, 50, 0);
        this.changeRoomBox[1].BoxInterract(this.scene.scene, this.centerX+600, this.centerY, 50, 0);
